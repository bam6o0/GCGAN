...
if __name__ == '__main__':
    ...
    parser.add_argument('--Dlayer', type=int, default=2, help='Number of D hidden layer')
    parser.add_argument('--hidden', type=int, default=200, help='Number of node on hidden layer')
